...
public class ReadTheSheet {
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        ...
        //TODO... repalce the url 
        final String url="https://docs.google.com/spreadsheets/d/1OfVQMbJqlc7YGGcDnkNMBxwKIv65Z25qp-5utivzrsw/edit#gid=0";
        
        //get the spreadsheetID from the url
        final String spreadsheetId=url.split("/")[5];
        
        // TODO : Add Range according to A1 notations
        final String range = "1:19";
        ...
        if (values == null || values.isEmpty()) {
            ...
            for (List column : values) {
                // TODO : this needs to be edited based on the sheet
                System.out.println(column);
                // System.out.printf("%s, %s, %s, %s\n", column.get(0), column.get(1), column.get(2), column.get(3), column.get(4));
            }
